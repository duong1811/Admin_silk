...
<body class="m-0 font-sans text-base antialiased font-normal leading-default text-slate-500 lg:min-h-screen" style="background-color: #1a2035">
    <main class="relative h-full transition-all duration-200 ease-in-out rounded-xl">
    @include('components/navbar')
    @include('components/sidebar')
    <!-- cards -->
    <div class="w-full px-3 lg:px-6 pt-3 mx-auto" style="background-color: #1a2035">
                        ...
                        <div class="flex flex-col bg-clip-border rounded-xl text-gray-700 bg-transparent">
                          <div class="px-0 pt-0">
                            <table id="table-sto" datatable data-page-size="10"
                              class="overflow-y-clip w-full text-white text-left border-b border-gray-100/80 text-sm">
                              <thead>
                        ...
                        <div class="flex flex-col bg-clip-border rounded-xl text-gray-700 bg-transparent">
                          <div class="px-0 pt-0">
                            <table id="table-encoder" datatable data-page-size="10"
                              class="overflow-y-clip response w-full min-w-max text-white text-left border-b border-gray-100/80 text-sm">
                              <thead>
                                <tr class="bg-slate-900 transition-colors text-md text-center">
                                  <th class="before:!bottom-2 after:!bottom-2 pl-2 py-2 cursor-pointer text-center">
                                    ID
...
<!-- main script file  -->
<script src="../assets/js/argon-dashboard-tailwind.js?v=1.3.4" async></script>
<script src="../assets/datatable/datatables.min.js"></script>
<script>
